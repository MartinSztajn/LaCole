...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100" style="font-family: system-ui;">
                        ...
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                    <ApplicationMark class="block h-9 w-auto"
                                                     onclick="window.location.href='/inicio'" :active="route().current('/inicio')"
                                    />
                            </div>

                            <!-- Navigation Links -->
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <button onclick="window.location.href='/login'" :active="route().current('/login')">
                                    <p>  Inicio </p>
                                </button>
                                <button onclick="window.location.href='/verUsuarios'" :active="route().current('/verUsuarios')">
                                    <p>  Usuarios </p>
                                </button>
                                <button onclick="window.location.href='/verProductos'" :active="route().current('/verProductos')">
                                    <p>  Productos </p>
                                </button>
                                <button onclick="window.location.href='/verCategoria'" :active="route().current('/verCategoria')">
                                    <p>  Categorias </p>
                                </button>
                                ...
                                <button onclick="window.location.href='/verColoresProducto'" :active="route().current('/verColoresProducto')">
                                    <p>  Colores </p>
                                </button>
