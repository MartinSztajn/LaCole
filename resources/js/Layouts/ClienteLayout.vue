    ...
    <div class="tipografia">
        ...
        <div class="min-h-screen bg-white-100" style="background-color: #F5F1F1">
            ...
            <nav style="background-color: #121212; width: 100%; position: fixed; z-index: 101; top: 0" >
                ...
                <a href="https://api.whatsapp.com/send?phone=541169793195&text=%C2%A1Hola%20Cole%20Market!%20Me%20gustar%C3%ADa%20contactarme%20con%20ustedes." class="whatsapp wpp" target="_blank">
