    ...
    <div>
        ...
        <div class="min-h-screen bg-white-100" style="background-color: #F5F1F1; font-family: system-ui;">
            <nav style="background-color: #121212; width: 100%; position: fixed; z-index: 101; top: 0" >
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <div class="flex-shrink-0 flex items-center">
                                        <button style="margin-top: 10px; margin-top: 3px" onclick="window.location.href='/inicio'" :active="route().current('/inicio')">
                                        ...
                                        <div style="margin-right: 20px; color: white">
                                            <div>
                                                ...
                                                <ul style="border: none;"  class="dropdown-menu" aria-labelledby="dropdownMenuLink" >
                                                    ...
                                                    <li>
                                                        <button onclick="window.location.href='/dashboard'" style="width: 150px">
                                                            <DropdownLink as="button" style="text-align: center">
                                                                Productos
                                                            </DropdownLink>
                                                        </button>
                                                    </li>
                                                    <hr style="border-bottom: 1px solid black; width: 90%; margin: 5%; ">
                                                    <li>
                                                        <button onclick="window.location.href='/user/profile'" style="width: 150px">
                                                            <DropdownLink as="button" style="text-align: center">
                                                                Cuenta
                                                            </DropdownLink>
                                                        </button>
                                        ...
                                        <div  v-if="showColors">
                                            <ul>
                                                <li v-for="col in colores"  style="float:left; margin-bottom: 5px; margin-left: 10px; margin-right: 10px; text-align: center">
                                                    <button @click="verProductosColores(col.nombre)" href="" style="float:left; margin-bottom: 5px; margin-left: 10px; margin-right: 10px; text-align: center">
                        ...
                        <div style="display: flex; justify-content: space-around;">
                            ...
                            <div v-if="usuario != 0">
                                <div style="margin-right: 20px; margin-top: 10px; color: white">
                                    <div>
                                        <a style="display: flex; color: white; text-align: center; font-size: 20px; background-color: #121212; border: none;" class="btn btn-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                                            <svg v-if="cantOfertasTotal == 0" style="margin-right: 10px; margin-top: 3px" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                                                <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
                                                <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z"/>
                                            </svg>
                                            <div v-if="cantOfertasTotal > 0" style="margin-right: 10px; margin-top: 3px" class="ofertas">{{cantOfertasTotal}}</div>
                ...
                <a href="https://api.whatsapp.com/send?phone=541169793195&text=%C2%A1Hola%20Cole%20Market!%20Me%20gustar%C3%ADa%20contactarme%20con%20ustedes." class="whatsapp wpp celular" target="_blank">
