...
<template>
    <cliente-layout>
        ...
        <form @submit.prevent="submit" style="margin-top: 80px; padding-left: 15%; padding-right: 15%">
            <div>
        ...
        <footer style="background-color: #EF7728;  margin-top: 2%;" class="text-center text-white">
            <!-- Grid container -->
