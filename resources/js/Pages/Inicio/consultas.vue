            ...
            <div class="compu">
                <div v-for="cat in categorias">
                    <a v-if="cat.hijos == null"
                       :href="'/verProductosCategoria/' + cat.id" style="display: block; color: white; text-align: center; position: center; float: left; font-size: 20px; margin-right: 20px; margin-top: 4px">
                        {{cat.nombre}}
                    </a>
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <li v-for="hijo in cat.hijos">
                            <a class="dropdown-item" :href="'/verProductosCategoria/' + hijo.id">{{hijo.nombre}}</a>
                        </li>
                    </ul>
                </div>
                <svg v-if="admin == 1"
                ...
                <section class="">
                    ...
                    <div class="row" style="margin-bottom: 3%">
                        <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
                            <h1 style="font-size: 20px; color: black"><b>Medios de Pago</b></h1>
                            <hr style="width: 60%; border: 2px solid white; margin-bottom: 10px; display: inline-table">
                            <ul class="list-unstyled mb-0">
                                <li>
                                    <a href="#!" class="text-white">Transferencia Bancaria</a>
                                </li>
                                <li>
                                    <a href="#!" class="text-white">Mercado Pago</a>
                                </li>
                                <li>
                                    <a href="#!" class="text-white">Efectivo</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li>
                                    <a href="#!" class="text-white">Correo Argentino</a>
                                </li>
                                <li>
                                    <a href="#!" class="text-white">Andreani</a>
                                </li>
                                <li>
                                    <a href="#!" class="text-white">Expresos</a>
                                </li>
                                <li>
                                    <a href="#!" class="text-white">A Convenir</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
                            ...
                            <hr style="width: 60%; border: 2px solid white; margin-bottom: 10px; display: inline-table">
                            <ul class="list-unstyled mb-0" style="display: flex; justify-content: space-evenly;">
                                <li style="margin-top: 5%">
                                    <svg @click="enviarMail" style="float: left; margin-right: 20px" xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                                        <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                                    </svg>
                                    <a href="https://www.instaram.com/wop.ok/">
                                        <svg  style="float: left; margin-right: 20px" xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
                                    ...
                                    <a href="https://wa.me/5491128495155?text=Buenos%20dias!%20Me%20gustaria%20tener%20más%20informacion" target="_blank">
                                        <svg style="float: left; margin-right: 20px" xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
                                        </svg>
                                    </a>
                                    <a href="mailto:admin@wop.com.ar">
                                        <svg style="float: left; margin-right: 20px" xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
