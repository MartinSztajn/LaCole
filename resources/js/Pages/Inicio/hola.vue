<template>
    <cliente-layout  style="font-family: 'circular'">
        ...
        <div style="margin-top: 4%">
            <h1 style="margin: 20px; text-align: center; font-size: 40px;"><b>¿Queres publicitar tu marca y/o servicio con toda la comunidad?</b></h1>
            <h2 style="margin: 10px; text-align: center; font-size: 25px">Dejanos tu mensaje</h2>
            <h2 style="margin: 10px; text-align: center; font-size: 25px">¡Muy pronto toda la comunidad podra ver tu banner!</h2>
