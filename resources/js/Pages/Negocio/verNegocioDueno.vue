    ...
    <dueno-layout>
        ...
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8" >
                <h1 style="margin: 20px; text-align: center; font-size: 50px">Negocios Existentes</h1>
                <div v-for="(neg, key) in negocios">
                    <a :href="'/verNegocioDetalle/' + neg.id ">
                        <div style="background-color: #17428A; color: white; width: 60%; margin-left: 20%; padding: 15px 30px 15px 30px; border-radius: 15px; margin-top: 5%">
                            <h1 style="font-size: 20px; text-align: center">{{neg.nombre}}</h1>
                        </div>
                    </a>
                </div>
            </div>
...
<script>
import DuenoLayout from '@/Layouts/DuenoLayout.vue'
export default {
    name: "verNegocioDueño",
    props: ['negocios','categorias','fotosBanner'],
    components: {
        DuenoLayout,
    },
    data()
