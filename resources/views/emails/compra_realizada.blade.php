                                                        ...
                                                        <tr>
                                                            <td class="content" style="padding:15px 25px;">
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    ...
                                                                    <tr>
                                                                        <td class="h4 white center pb10" style="font-family:'Noto Serif', Georgia, serif; font-size:25px; line-height:40px; color:#ffffff; text-align:center; padding-bottom:10px;"><multiline>Tu Oferta fue realizada con exito!</multiline></td>
                                                                    </tr>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td class="text4 left pb20" style="color:#000000; font-family:'Raleway', Arial,sans-serif; font-size: 20px; line-height:35px; text-align:center;" ><div style="margin-bottom: 20px">
                                                                    @if(true)  <div>¡Hola {{$nombre}} {{$apellido}}! Ofertaste por el siguente producto: <br><br></div> @endif
                                                                    @if(true)  <div>Precio: ${{$precio}} <br> </div> @endif
                                                                    @if(true)  <div>Cantidad: {{$cantidad}} <br> </div> @endif
                                                            </td>
                                                        </tr>
                                        ...
                                        <tr>
                                            <td class="footer" style="padding:20px 30px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#000000">
                                                    <tr>
                                                        <td class="footer">
                                                                ...
                                                                <tr>
                                                                    <td class="pb30" align="center" style="padding-bottom:30px;">
                                                                        <table border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td class="img" width="40" style="font-size:0pt; line-height:0pt; text-align:left;"><a href="https://www.instagram.com/wop.ok/" target="_blank"><img src="https://res.cloudinary.com/dwupcbw92/image/upload/v1622505353/t_white_ico_youtube_clrk8u.gif" width="40" height="40" style="max-width:40px;" border="0" alt="" /></a></td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                </tr>
                                                            ...
                                                            <table width="49%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td class="social-title pb30" style="color:#ffffff; font-family:'Raleway', Arial, sans-serif; font-size:14px; line-height:22px; text-align:center; text-transform:uppercase; "><div >Telefono: 1128495155 </div></td>
                                                                </tr>
                                                    ...
                                                    <a href="">
                                                        <tr>
                                                            <td class="text4 left pb20" style="color:#d2d4ff; font-family:'Raleway', Arial,sans-serif; font-size: 20px; line-height:35px; text-align:center; " ><div style="margin: 15px">¡Muchas gracias por elegirnos! - WOP</div></td>
                                                        </tr>
                                                    </a>
                                                </table>
                                            </td>
